...
export default function Signup({token, setToken}) {
    ...
    async function log(event) {
        ...
        let api = await fetch("http://localhost:8000/api/users/sign/", {method: "POST", headers: {'Content-Type': "application/json"}, body: JSON.stringify({"email": email, "password": pass, "fio": fio})})
